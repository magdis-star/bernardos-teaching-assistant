...
interface WhoWeAreLookingForProps {
  content: Content['whoWeAreLookingFor'];
}

export default function WhoWeAreLookingFor({ content }: WhoWeAreLookingForProps) {
  return (
    <section className="py-12 bg-white" aria-labelledby="who-we-are-looking-for-heading">
      <div className="container-custom">
        <h2
          id="who-we-are-looking-for-heading"
